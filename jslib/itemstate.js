const ItemState = {
     ...
     */
    PENDING:{val:"PENDING", isPending: true, isPositive: false, isApproved: false, ordinal:1},
    /**
     * The contract is locally checked and found OK against local ledger, voting is in progress and no consensus is
     * found.
     */
    PENDING_POSITIVE:{val:"PENDING_POSITIVE", isPending: true, isPositive: true, isApproved: false, ordinal:2},
    /**
     * The contract is locally checked and found bad, but voting is yet in progress and yet no consensus is found.
     */
    PENDING_NEGATIVE:{val:"PENDING_NEGATIVE", isPending: true, isPositive: false, isApproved: false, ordinal:3},
    /**
