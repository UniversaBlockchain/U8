...
ItemResult.prototype.deserialize = function (data, deserializer) {
...
ItemResult.prototype.serialize = function (serializer) {
    return {
...
ItemResult.from = function(state,haveCopy,createdAt,expiresAt) {
    this.state = state;
...
ItemResult.fromStateRecord = function(record, haveCopy) {
...
ItemResult.fromReader = function(reader) {
...
ItemResult.prototype.writeTo = function (writer) {
...
ItemResult.prototype.equals = function(to) {
    if(this === to)
        return true;
...
ItemResult.prototype.toString = function () {
